<?php
	...
	{
		global $mysqli;
		//$email="ra05055@yahoo.com";
				if($stmt = $mysqli->prepare("SELECT * FROM usuarios WHERE correo=?")){
   ...
   $rnum = $stmt->num_rows;
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = '483melz@gmail.com'; //Modificar
		$mail->Password = 'blanqui92'; //Modificar
		
		$mail->setFrom('483melz@gmail.com', 'prueba'); //Modificar

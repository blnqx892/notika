              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="data-table-list">
                    <div class="pull-right">
                        <button class="btn btn-success notika-btn-success">Liquidados <i class="fas fa-arrow-alt-circle-up"></i></button>
                    </div>
                          ...
                          <table id="data-table-basic" class="table table-striped">
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td>12/10/2019</td>
                                      <td>14/10/2019</td>
                                      <td><center> <button class="btn btn-info info-icon-notika btn-reco-mg btn-button-mg" data-toggle="modal" data-target="#modalVe"><i class="fas fa-eye"></i></button></center></td>
                                        ...
                                        <div class="modal-dialog modal-large">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="typography-hd-cr-4" ><h2>Datos Personales del Responsable</h2></div>
                                                      <hr style="width:100%;border-color:light-gray 25px;"><br>
                                                        <div class="cmp-tb-hd bcs-hd">
                                                            ...
                                                            <div class="typography-hd-cr-4" ><h2>Datos de la Empresa</h2></div>
                                                              <hr style="width:100%;border-color:light-gray 25px;"><br>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <div class="form-group ic-cmp-int">
                                                                    <div class="form-ic-cmp">
                                                        ...
                                                        <div class="cmp-tb-hd bcs-hd">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <div class="form-group ic-cmp-int">
                                                                    ...
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control" placeholder="Telefono 9999-9999" disabled="disabled">
                                                                    </div>
                                                                </div>
                                                            </div><br><br><br><br><br>
                                                            <div class="typography-hd-cr-4" ><h2>Datos de la Empresa</h2></div>

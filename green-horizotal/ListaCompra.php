                                        ...
                                        <div class="modal-dialog modal-large">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h3>Editar Datos de Compra</h3><br><br>
                                                    <div class="typography-hd-cr-4" ><h2>Datos</h2></div>
                                                        ...
                                                        <div class="cmp-tb-hd bcs-hd">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <div class="form-group ic-cmp-int">
                                                                    ...
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control" placeholder="Producto" disabled="disabled">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="cmp-tb-hd bcs-hd">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <div class="form-group ic-cmp-int">
                                                                    ...
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control" placeholder="Descripcion" disabled="disabled">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">

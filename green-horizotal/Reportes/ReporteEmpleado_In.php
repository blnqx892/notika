...
<table width="685" border="0" align="center">
  ...
  <tr align="center">
    <td colspan="2"><strong class="titulos">REPORTE DE EMPLEADOS Inactivos</strong></td>
  </tr>
  <tr align="left">
...
<table width="700" border="1" align="center" rules="all">
  ...
  <td width="29" align="center" bgcolor="#20CDBD" class=""><strong>N°</strong></td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Nombres</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Apellidos</td>
...
$contador=1;
$sql = "select * from empleado where estado_Emple='0' order by nombres_Emple ASC";

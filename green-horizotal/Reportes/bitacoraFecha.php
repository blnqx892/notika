...
<table width="700" border="1" align="center" rules="all">
  <tr bgcolor="#CCCCCC">
	...
	$desde = $_GET['desde'];
  $hasta = $_GET['hasta'];
	$sql = "SELECT bitacora.sesionInicio,
                 bitacora.usuario_Usu,
                 bitacora.actividad FROM bitacora WHERE CAST(sesionInicio AS DATE) BETWEEN'".$desde."' AND '".$hasta."'";
...
//  var_dump($consulta);
  ...
  <tr align="left" class="">
    ...
    <td bgcolor=""><?php echo date('d-m-Y H:i:s A',strtotime($fila[0]));?></td>

...
<table width="685" border="0" align="center">
  ...
  <tr align="center">
    <td colspan="2"><strong class="titulos">REPORTE DE PROVEEDORES Inactivos</strong></td>
  </tr>
  <tr align="left">
...
<table width="700" border="1" align="center" rules="all">
  <tr bgcolor="#CCCCCC">
    <th width="29" align="center" bgcolor="#20CDBD" class=""><strong>N°</strong></th>
    <th width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Empresa</th>
...
$contador=1;
$sql = "select * from proveedor where estado_Provee='0' order by nombre_prov ASC";

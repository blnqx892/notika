...
<table width="700" border="1" align="center" rules="all">
  <tr bgcolor="#CCCCCC">
    ...
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Hora</td>
    <?php if ($tipor == 2) {?>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Usuario</td>
    <?php }  ?>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Actividad</td>
  </tr>
  ...
  <tr align="left" class="">
    ...
    <td bgcolor="" align="center"><?php echo date('H:i:s A',strtotime($fila[2]));?></td>
    <?php if($tipor == 2){ ?>

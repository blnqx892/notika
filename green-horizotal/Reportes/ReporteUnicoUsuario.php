...
<?php $rol = array(1 => "Administrador", 2 => "Empleado"); ?>
<body>
...
<table width="700" border="1" align="center" rules="all">
  <tr bgcolor="#CCCCCC">
    ...
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Correo</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Rol</td>
    </tr>
...
//$sql = "select * from proveedor order by nombre_prov ASC";
  ...
  <tr align="left" class="">
    ...
    <td bgcolor="" align="center"><?php echo $rol[$fila[5]];?></td>
  </tr>
  <?php $contador++;
}
  ?>

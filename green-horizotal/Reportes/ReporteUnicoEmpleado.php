...
<table width="685" border="0" align="center">
  ...
  <tr align="center">
    <td colspan="2"><strong class="titulos">REPORTE DE EMPLEADOS</strong></td>
  </tr>
  <tr align="left">
...
<?php 
 ...
 $aux = $idusu;
 $sql1 = "SELECT * FROM empleado where Dui_Emple = '$aux'";
 $usuario = mysqli_query($conexion, $sql1) or die("No se puedo ejecutar la consulta");
 $usuario = mysqli_fetch_assoc($usuario);
 $nusu = $usuario['Dui_Emple'];?>
  <table width="685" border="0" align="center">
    <tr align="center">
      
      <td ><strong class="titulos" align="center">EMPLEADO: </strong>
        <?php echo $usuario['Dui_Emple']?>
      </td>
    </tr>
    </table>
  <br>
<table width="700" border="1" align="center" rules="all">
  <tr bgcolor="#CCCCCC">
    ...
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Dui</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Nombre</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Apellido</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Dirección</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Teléfono</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Fecha de Ingreso</td>
    <td width="87" align="center" bgcolor="#20CDBD" class="formatoTabla">Cargo</td>
    </tr>
...
//$sql = "select * from proveedor order by nombre_prov ASC";
  ...
  <tr align="left" class="">
    ...
    <td bgcolor="" align="center"><?php echo $fila[7];?></td>
  </tr>
  <?php $contador++;
}
  ?>

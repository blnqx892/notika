                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>REGISTRAR PAQUETES FUNEBRES</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="inbox-left-sd">
                        ...
                        <div class="inbox-status">
                            <ul class="inbox-st-nav inbox-ft">
                                ...
                                <a href="Catalogo.php"><button data-toggle="modal" data-target="#modalNuevoPaquete"
                                    class="btn btn-success notika-btn-success">Catalogo <i class="fas fa-plus-circle">
                                    </i></button></a>
                            </ul>
                        </div>
                        <hr>
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <div class="data-table-list"><br><br>
                    <div><div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="chosen-select-act fm-cmp-mg">
                                <select class="chosen" name="rol" data-placeholder="Elegir .." aria-hidden="true">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-default">Agregar</button></div>
                        <br><br><br><br>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="form-group ic-cmp-int">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" required class="form-control" placeholder="Nombre del Paquete"
                                        name="nombre">
                                </div>
                            </div>
                        </div><br>
